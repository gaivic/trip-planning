...
const TripPlan = ({ active, onDayClick, deletePlace, post ,schedule}) => {
    ...
    return (
        <div>
            ...
            <div className='p-4'>
                <div className="flex items-center gap-3 overflow-x-auto border border-gray-400 rounded-full">
                    <Button
                        variant="text"
                        color="blue-gray"
                ...
                <PlaceList schedule={schedule} activeDay={active} deletePlace={deletePlace}/>
            </div>
        </div>
    );
}
