...
export default function InfoCard({ name, rating, photos, placeId, onClose, active }) {
    ...
    return (
        <Card className="w-72 overflow-hidden rounded-none">
            ...
            <CardBody className='mb-0'>
                {!photos && <div className="absolute top-2 left-2 text-black hover:text-gray-700 z-10 text-2xl font-bold cursor-pointer" onClick={onClose} >
                        <IoMdClose />
                    </div>}
